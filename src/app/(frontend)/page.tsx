...
const Page: NextServerPage = async ({ searchParams }) => {
  ...
  return (
    <>
      ...
      {Boolean(data.questions) && (data.questions!.length > 0) && <section className="py-16 bg-gray-50">
        <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
          ...
          <p className="text-center text-gray-600 textbase mt-9">{data.questionAlternativeText}</p>
        </div>
      </section>}
