        ...
        <div className="text-center xl:flex xl:items-center xl:justify-between xl:text-left">
          ...
          <div className="items-center mt-8 xl:mt-0 xl:flex xl:justify-end xl:space-x-8">
            <ul className="flex flex-wrap items-center justify-center gap-x-8 gap-y-3 xl:justify-end">
              ...
              <li>
                <Link href="/kebijakan-privasi" title="" className="text-sm text-white transition-all duration-200 hover:text-opacity-80 focus:text-opacity-80"> Kebijakan Privasi </Link>
              </li>
            ...
            <ul className="flex items-center justify-center space-x-8 xl:justify-end">
              {props.profile.socialMedia?.twitterLink && <li>
                <Link href={props.profile.socialMedia?.twitterLink} target="_blank" title="" className="block text-white transition-all duration-200 hover:text-opacity-80 focus:text-opacity-80">
              ...
              {props.profile.socialMedia?.facebookLink && <li>
                <Link href={props.profile.socialMedia?.facebookLink} target="_blank" title="" className="block text-white transition-all duration-200 hover:text-opacity-80 focus:text-opacity-80">
                  <svg className="w-6 h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
              ...
              {props.profile.socialMedia?.instagramLink && <li>
                <Link href={props.profile.socialMedia?.instagramLink} target="_blank" title="" className="block text-white transition-all duration-200 hover:text-opacity-80 focus:text-opacity-80">
                  <svg className="w-6 h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
