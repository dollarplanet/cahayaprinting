...
export const CategoryChip = (props: Props) => {
  return (
    <div className="rounded-md bg-gray-300 flex items-center gap-1 py-[2px] px-1 border border-transparent text-gray-700 transition-all shadow-sm">
      ...
      <div className="text-[0.5rem] font-bold">{props.category.name}</div>
    </div>
  )
}